...
\usepackage{graphicx}
\usepackage[pagecolor=none]{xcolor} % FIXED
\usepackage{tikz}
\usepackage{setspace}
\usepackage{array}
\usepackage{titlesec}
...
% Ensure normal background for whole document
\pagecolor{white}

% ================= COVER PAGE =================
\begin{titlepage}

% Cover page background ONLY
\pagecolor{lightblue}

% Decorative Border
\begin{tikzpicture}[remember picture, overlay]
\draw[line width=6pt, color=mainblue]
...
{\Huge \bfseries \textcolor{mainblue}{BEGUM ROKEYA UNIVERSITY}}
...
\centering
\vspace{0.5cm}
{\Huge \color{white} \bfseries ASSIGNMENT}
\vspace{0.5cm}
}}

\vspace{1.8cm}

{\Large \textbf{\textcolor{gold}{Course Title:}}}

\vspace{0.4cm}

{\huge \bfseries \textcolor{mainblue}{Categorical Data Analysis}}

\vspace{0.8cm}

{\Large \textbf{Course Code: STAT 4104}}
...
\hline
\multicolumn{1}{|c|}{\textbf{Submitted By}} & 
\multicolumn{1}{c|}{\textbf{Submitted To}} \\
\hline
Md. Abu Sayeed &  Dr. Md. Siddikur Rahman ,     Associate Professor\\
\hline
ID: 12110054 & Department of Statistics \\
\hline
Reg. No: 000015917 & Begum Rokeya University, Rangpur \\
\hline
\end{tabular}
...
\centering
\vspace{0.3cm}
{\Large \textbf{Submission Date: \tomoroww}}
\vspace{0.3cm}
}}
...
% Restore white background after title page
\end{titlepage}
